...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/EyesOnThePrize"+request.text.substring(5,8));
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/EyesOnThePrize/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/EyesOnThePrize/players?name="+rep+"&position=all&team=all");
